    ...
    const fetchData = async () => {
      try {
        ...
        if (Array.isArray(res.data)) {
                  const patientsList = res.data.filter((user) => user.role === "patient");
                  ...
                  Swal.fire({
                    title: "Error",
                    icon: "error",
                    text: "Error Fetching Patients! Please Try Again!",
                  });
                }
              } catch (error) {
                ...
                Swal.fire({
                  title: "Error",
                  icon: "error",
                  text: "Unable to load Patients list. Please check your connection.",
                });
              }
    };
