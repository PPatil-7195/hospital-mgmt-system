    ...
    const fetchDoctors = async () => {
      try {
        ...
        if (Array.isArray(res.data)) {
          const doctorsList = res.data.filter((user) => user.role === "doctor");
          ...
          Swal.fire({
            title: "Error",
            icon: "error",
            text: "Error Fetching Doctors! Please Try Again!",
          });
        }
      } catch (error) {
        ...
        Swal.fire({
          title: "Error",
          icon: "error",
          text: "Unable to load doctors list. Please check your connection.",
        });
      }
    };
