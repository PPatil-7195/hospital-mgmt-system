            ...
            <div>
              ...
              <div className="mt-2">
                <select
                  ...
                  className="flex h-10 w-full rounded-md border border-black bg-transparent px-3 py-2 text-sm text-black focus:outline-none focus:ring-1 focus:ring-gray-400"
                >
